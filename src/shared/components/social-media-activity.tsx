...
export function SocialMediaActivity() {
  ...
  return (
      ...
      <div>
        <h1 className={`${interBold.className} text-[#121417] text-[1.25rem] `}>Social Media Activity</h1>
        <p className={`${interRegular.className} text-[#667582] text-[0.875rem]`}>Recent student posts on social media</p>
      </div>
           ...
           <Avatar
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between">
                ...
                <span  className={`${interRegular.className}  text-[#667582] text-[0.875rem]`}>{post.time}</span>
              </div>
              <p  className={`${interRegular.className}  text-[#667582] text-[0.875rem]`}>{post.content}</p>
            </div>
          </div>
        ))}
      </div>
