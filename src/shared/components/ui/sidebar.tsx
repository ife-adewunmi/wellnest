...
const SIDEBAR_WIDTH_MOBILE = '18rem' // Keep this one, it's specific to SheetContent
// const SIDEBAR_WIDTH_ICON = "3rem"

// Re-export SidebarProvider from context file
export { ContextSidebarProvider as SidebarProvider, useSidebar }
...
>(
  (
    ...
    return (
      // Removed TooltipProvider and outer div from here, as they are now in SidebarProvider
      <div
        ref={ref}
        ...
        data-side={side}
        // Removed style prop here, as it's now in SidebarProvider
      >
