  ...
  return (
    <Card className="@container/card">
      <CardHeader className="relative">
        <CardTitle className={`text-[#0F141A] text-[0.875rem] ${interMedium.className}`}>Average Mood History</CardTitle>
        <div className="flex items-center justify-between mt-2">
          <div>
            <div className={`text-[#121417] text-[1.25rem] ${interBold.className}`}>{averageMood}</div>
            <div className="flex items-center">
              <span className={`text-[#667582] text-[12px] ${interRegular.className}`}>Last 7 Days</span>
              <span className={`text-[#088738] text-[12px] ${interRegular.className}`}>+10%</span>
            </div>
          </div>
        </div>
